var baseDir, chai, direct, noflo, path;
...
describe('Runtime protocol', function() {
  ...
  return describe('with a graph containing exported ports', function() {
    ...
    it('should be possible to start the network', function(done) {
      ...
      runtime.runtime.on('ports', function(emittedPorts) {
        return ports = emittedPorts;
      });
    ...
    it('packets sent to IN should be received at OUT', function(done) {
      ...
      messageListener = function(msg) {
        if (msg.protocol !== 'runtime') {
          return;
        }
        if (msg.command !== 'packet') {
          return;
        }
        if (msg.payload.port !== 'out') {
          return;
        }
        if (msg.payload.event !== 'data') {
          return;
        }
