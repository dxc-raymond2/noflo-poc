...
describe('Network protocol', function() {
  ...
  client = null;
  before(function() {
    return runtime = new direct.Runtime({
      permissions: {
  ...
  describe('defining a graph', function() {
  ...
  return describe('starting the network', function() {
    it('should process the nodes and stop when it completes', function(done) {
      var expects;
      expects = ['started', 'connect', 'data', 'connect', 'data', 'disconnect', 'disconnect', 'stopped'];
      client.on('error', function(err) {
        return done(err);
      });
      client.on('message', function(msg) {
