...
describe('Inport Port', function() {
  ...
  describe('with custom type', function() {
    ...
    return it('should retain the type', function() {
      ...
      return chai.expect(p.getSchema()).to.equal('text/url');
    });
  });
  ...
  return describe('with IP handle callback option', function() {
    ...
    it('should stamp an IP object with the port\'s datatype', function(done) {
      ...
      return p.handleIP(new noflo.IP('data', 'Hello'));
    });
    it('should keep an IP object\'s datatype as-is if already set', function(done) {
      ...
      return p.handleIP(new noflo.IP('data', 123, {
        datatype: 'integer'
      }));
    });
    ...
    return it('should keep an IP object\'s schema as-is if already set', function(done) {
      var p;
      p = new noflo.InPort({
        datatype: 'string',
        schema: 'text/markdown'
